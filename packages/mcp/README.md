...
This guide belongs to `@dexterai/opendexter@1.24.0`. Its executable examples
are pinned to those exact package bytes.

Install the local MCP into detected clients:

```bash
npx @dexterai/opendexter@1.24.0 setup
```
...
```bash
npx @dexterai/opendexter@1.24.0 connect
npx @dexterai/opendexter@1.24.0 connect status
```
...
```bash
npx @dexterai/opendexter@1.24.0 doctor --client codex
```
...
```bash
npx @dexterai/opendexter@1.24.0 install --client cursor
```
...
```bash
claude mcp add --scope user opendexter -- npx -y @dexterai/opendexter@1.24.0
```
...
```bash
npx @dexterai/opendexter@1.24.0 wallet
```
...
```bash
npx @dexterai/opendexter@1.24.0 wallet --legacy-recovery
```
