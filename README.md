...
The commands pin version `1.24.0` so your clients use the same release.
...
Run `npx @dexterai/opendexter@1.24.0 doctor` for a read-only report. Doctor
...
- **Prepare a compatible service for discovery:** run
  `npx @dexterai/opendexter@1.24.0 audition https://your-service.example`.
